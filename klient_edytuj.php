...
$sql = "SELECT id, imie, nazwisko, miasto FROM klient";
 ...
 echo "<table id='table_id' class='display'><thead><tr>
	 ...
	 while($row = mysql_fetch_row($result)) {
          echo "<tr class='odd gradeA'><td>$row[0]</td>
					...
					<td><a href='edytujk.php?edytujk=$row[0]'><img src='png/edytuj.png' alt='Edytuj' /></a> <a href='usunk.php?usunk=$row[0]'><img src='png/usun.png' alt='Usun' /></a></td>					
					</tr>";
     }
	 echo "</tbody></table>";
} else {
